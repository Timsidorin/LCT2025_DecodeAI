...
CREATE INDEX idx_reviews_region_code ON reviews(region_code);
...
COMMENT ON COLUMN reviews.region IS 'Регион автора';
COMMENT ON COLUMN reviews.region_code IS 'Код региона (автоматически)';
